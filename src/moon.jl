...
function moon_nearest_phase(jd::Float64, phase=0)
     ...
     _cor   =   Dict(
               0.000325 => Array([299.77,  0.107408*1236.85, -0.009173]),
               0.000165 => Array([251.88,  0.016321*1236.85]),
               0.000164 => Array([251.83, 26.651886*1236.85]),
               0.000126 => Array([349.42, 36.412478*1236.85]),
               0.000110 => Array([ 86.66, 18.206239*1236.85]),
               0.000062 => Array([141.74, 53.303771*1236.85]),
               0.000060 => Array([207.14,  2.453732*1236.85]),
               0.000056 => Array([154.84,  7.306860*1236.85]),
               0.000047 => Array([ 34.52, 27.261239*1236.85]),
               0.000042 => Array([207.19,  0.121824*1236.85]),
               0.000040 => Array([291.34,  1.844379*1236.85]),
               0.000037 => Array([161.72, 24.198154*1236.85]),
               0.000035 => Array([239.56, 25.513099*1236.85]),
               0.000023 => Array([331.55,  3.592518*1236.85])
               )
    ...
    for (k, poly) in _cor
        mean_phase = mean_phase + k * sin(mod2pi(deg2rad(polynomial(poly, T))))
    end
    return mean_phase
end
