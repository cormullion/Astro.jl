...
_kL0 = Array([deg2rad(280.46646),  deg2rad(36000.76983),  deg2rad( 0.0003032)])
_kM  = Array([deg2rad(357.52911),  deg2rad(35999.05029),  deg2rad(-0.0001537)])
_kC  = Array([deg2rad(  1.914602), deg2rad(   -0.004817), deg2rad(-0.000014)])
